...
def page_turning():
    ...
    print('期望第一行第一列的设备号：' + next_page_data)
    testlink('第一行第一列的设备号为：' + first_page_data + '；第一行第一列的设备号为：' + next_page_data)
    if first_page_data == next_page_data:
        tool.FailedFlag = True
        print('实际第一行第一列的设备号为：' + first_page_data)
    ...
    print('期望第一行第一列的设备号为：' + last_page_data)
    testlink('翻页前第一行第一列的设备号为：' + next_page_data + '；翻页后第一行第一列的设备号为：' + last_page_data)
